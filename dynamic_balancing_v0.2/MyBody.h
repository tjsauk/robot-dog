...
public:
  ...
  void GoSitPosition(unsigned long mills, unsigned long duration, double ramp= 0.0);
  void GoGivePawPosition(unsigned long mills, unsigned long duration, double ramp= 0.0);
  ...
  bool isLegInTrajectory(coords sLeg,coords eLeg, double y_rot, double x, double z);
