...
private:
  ...
  coords StepCurve(double percentage, double y_rot, double x, double z);
...
public:
  ...
  void DoStep( double percentage,  double y_rot, double x , double z);
  void WalkWithDelta(coords delta);          
  coords getStep( double percentage,  double y_rot, double x , double z);
  legState getPoints();
  coords getPawPosition();
  coords getPawPositionInBody();
  double vectorLenght(double x, double z);
  coords rotateInPlace(double percentage,double radius,double y_rot);
  coords rotateWhileWalking(double percentage,double y_rot,double x, double z);
};
